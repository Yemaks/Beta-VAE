...
class BetaVAE_H(nn.Module):
    ...
    def __init__(self, z_dim=10, nc=3):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.Conv2d(512, 1024, 4, 1),  # B, 1024, 1, 1
            nn.ReLU(True),
            View((-1, 1024 * 1 * 1)),  # B, 1024
            nn.Linear(1024, z_dim * 2),  # B, z_dim*2
        )
        self.decoder = nn.Sequential(
            nn.Linear(z_dim, 1024),  # B, 1024
            View((-1, 1024, 1, 1)),  # B, 1024, 1, 1
            nn.ReLU(True),
            nn.ConvTranspose2d(1024, 512, 4),  # B, 512, 4, 4
            nn.ReLU(True),
